					...
					<div id="content">
						...
						<div class="formbody">
							...
							<div id="usual1" class="usual">
								...
								<div class="itab">
									<ul>
										<li><a href="#tab111" class="selected">个人信息</a></li>
								...
								<ul class="forminfo">
									<li><label>读者证号<b>*</b></label>${ sessionScope.username}</li>
									<li><label>身份证号<b>*</b></label>${ sessionScope.idCard}</li>
									</br>
									</br>
									</br>
							...
							<div id="usual1" class="usual">
								...
								<div class="itab">
									<ul>
										<li><a class="selected">资料修改</a></li>

									</ul>
								</div>

								<form:form method="post" action="/front/myDataResetPass"
									modelAttribute="myData_reset_pass">
									<div id="tab1" class="tabson">

										<ul class="forminfo">
											<li><label>原密码<b>*</b></label><input name="password1"
												id="password1" type="text" class="dfinput" style="width: 308px;" /><b>${message1}</b></li>

											<li><label>新密码<b>*</b></label><input name="password2"
												id="password2" type="text" class="dfinput" style="width: 308px;" /><b>${message2}</b></li>
												
											<li><label>请确认新密码<b>*</b></label><input name="password3"
												id="password3" type="text" class="dfinput" style="width: 308px;" /><b>${message3}</b></li>
											</br>
											<li><label>&nbsp;</label><input name="submit"
												type="submit" id="submit" class="btn" value="确认修改" /></li>
										</ul>
