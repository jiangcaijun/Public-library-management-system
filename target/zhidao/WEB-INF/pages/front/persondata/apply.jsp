						...
						<div class="formbody">
							...
							<div id="usual1" class="usual">
								...
								<table id="tt" class="easyui-datagrid" title="information"
									...
									data-options="pagination:true,fitColumns:true,singleSelect:true,collapsible:true,url:'/front/apply_info',method:'post'">
									<thead>
										<tr>
											<th data-options="field:'bookName',width:80">书名</th>
											<th data-options="field:'username',width:80">读者名</th>
											<th data-options="field:'applyTime',width:80">借书时间</th>
											<th data-options="field:'status',width:80">是否已取消预约（0：未取消，1，已取消）</th>
										</tr>
									</thead>
								</table>
							</div>
