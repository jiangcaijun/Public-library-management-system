	...
	<div id="navbar">
		<div class="navbar_bd">
			...
			<div class="navbar_info_zh">
				...
				欢迎您,${ sessionScope.username}&nbsp; <a href="/front_logout" onclick="return logout1()"> 退出
				<!--a href="">帮助</a-->
			</div>
		</div>
	</div>
		...
		<div id="page_content">
			...
			<div id="contentDiv">
				<div id="left_div">
					...
					<div class="inner_div">
						<ul>
							<li><a href="/front/persondata"> <img
							...
							<li><a href="/front/late"><img
									src="http://my1.hzlib.net/opac3/media/images/financeList_first_1.png" />
									<br />过期书籍</a></li>
							<!-- 是否显示积分查看菜单 -->
							<li><a href="/front/apply">
									<img
				...
				<div id="content">
					...
					<div class="formbody">
						...
						<div id="usual1" class="usual">
							...
							<div class="itab">
								<ul>
									<li><a href="#tab111" class="selected">当前正借阅的书籍</a></li>

								</ul>
							</div>
							<table id="tt" class="easyui-datagrid" title="当前正借阅的书籍"
								style="width: 1000px;" toolbar="#toolbar"
								data-options="pagination:true,fitColumns:true,singleSelect:true,collapsible:true,url:'/front/borrowAndReturn_info',method:'post'">
								<thead>
									<tr>
										<th data-options="field:'book_id',width:80">书籍唯一标识</th>
										<th data-options="field:'book_name',width:80">书籍名</th>
										<th data-options="field:'borrow_time',width:80">借书时间</th>
										<th data-options="field:'will_return_Time',width:80">应归书时间</th>
							...
							<div class="itab">
								<ul>
									<li><a href="#tab111" class="selected">已归还的书籍</a></li>

								</ul>
							</div>
							</br>
							<table id="tt" class="easyui-datagrid" title="已归还的书籍"
								style="width: 1000px;" toolbar="#toolbar"
								data-options="pagination:true,fitColumns:true,singleSelect:true,collapsible:true,url:'/front/borrowAndReturn_info2',method:'post'">
								<thead>
									<tr>
										<th data-options="field:'book_id',width:80">书籍唯一标识</th>
										<th data-options="field:'book_name',width:80">书籍名</th>
										<th data-options="field:'borrow_time',width:80">借书时间</th>
										<th data-options="field:'return_time',width:80">还书时间</th>
									</tr>
								</thead>
							</table>
						</div>
