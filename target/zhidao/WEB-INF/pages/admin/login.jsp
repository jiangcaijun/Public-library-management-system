...
<body
	...
	<div class="loginbody">
		...
		<form:form method="post" action="/admin" modelAttribute="adminLogin">
			<div class="loginbox">
				<ul>
					<li><input  type="text" name="username" id="username"
						class="loginuser" value="admin1" onclick="JavaScript:this.value=''" /></li>
					<li><input type="password" name="password"
						id="password" class="loginpwd"  value="admin1"
						onclick="JavaScript:this.value=''" /></li>
					<li><input name="submit" type="submit" id="submit"
						class="loginbtn" value="登录"/>
						<label><input
							name="" type="checkbox" value="" checked="checked" />两周内记住密码</label></li>
				</ul>
			</div>
		</form:form>
	</div>
