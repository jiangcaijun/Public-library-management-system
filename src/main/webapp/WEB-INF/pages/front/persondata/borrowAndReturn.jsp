							...
							<table id="tt" class="easyui-datagrid" title="当前正借阅的书籍"
								...
								<thead>
									<tr>
										...
										<th data-options="field:'will_return_Time',width:80,formatter: formatDatebox">应归还时间</th>
									</tr>
								</thead>
							</table>
							</br> </br>
							...
							<table id="tt" class="easyui-datagrid" title="已归还的书籍"
								...
								<thead>
									<tr>
										...
										<th data-options="field:'book_name',width:80">书籍名</th>
										<th data-options="field:'borrow_time',width:80,formatter: formatDatebox">借书时间</th>
									<th data-options="field:'return_time',width:80,formatter: formatDatebox">实际还书时间</th>
									</tr>
								</thead>
							</table>
						</div>
