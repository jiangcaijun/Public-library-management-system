					...
					<div id="content">
						...
						<div class="formbody">
							...
							<div id="usual1" class="usual">
								...
								<form:form method="post" action="/front/myData"
									modelAttribute="myData_reset_pass">
									<div id="tab1" class="tabson">

										<ul class="forminfo">
											<li><label>原密码<b>*</b></label><input name="password1"
												id="password1" type="password" class="dfinput" style="width: 308px;" /><b>${message1}</b></li>

											<li><label>新密码<b>*</b></label><input name="password2"
												id="password2" type="password" class="dfinput" style="width: 308px;" /></li>
												
											<li><label>请确认新密码<b>*</b></label><input name="password3"
												id="password3" type="password" class="dfinput" style="width: 308px;" /><b>${message2}</b></li>
											</br>
