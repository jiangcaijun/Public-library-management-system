					...
					<div class="facetList">
						<div class="facetContainer">
							...
							<ol id="curlibcodeFacetUL">
								...
								<!-- 将x值转换为c值处理 -->
								<li><a
									href="/front/search_theme?theme=编程"
									title="2"> 编程</a></li>
								<!-- 将x值转换为c值处理 -->
								<li><a
									href="/front/search_theme?theme=文化"
									title="3"> 文化 </a></li>
								<!-- 将x值转换为c值处理 -->
								<li><a
									href="/front/search_theme?theme=经济"
									title="3"> 经济</a></li>
								<!-- 将x值转换为c值处理 -->
							</ol>
						</div>
						<div class="facetContainer">
							<ol id="subjectFacetUL">
								...
								<li><a
									href="/front/search_autor?autor=余秋雨"
									title="915"> 余秋雨</a></li>
								<li><a
									href="/front/search_autor?autor=梁勇"
									title="785"> 梁勇 </a></li>
							</ol>
						</div>
					</div>
	...
	<div id="page_footer">
		<div class="page_footer_bd">
			<span> © 2005－2014 www.interlib.com.cn, all rights reserved </span> <span
				class="fcenter"> </span> <span class="fright"> <a href="#">
					关于 </a> <a href="#"> 联系我们
			</a> <a href="#">
					帮助 </a> <!--a href="#">隐私声明</a-->
			</span>
